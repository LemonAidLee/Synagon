...
def install_extension(vsix_file: str) -> bool:
    ...
    if not os.path.isfile(ide_cmd):
        candidate = r"C:\Users\Asus\AppData\Local\Programs\Antigravity IDE\bin\antigravity-ide.cmd"
    ...
    user_exts = os.path.expanduser(r"~/.antigravity-ide/extensions/project-beta.antigravity-terminal-bridge-1.0.0")
