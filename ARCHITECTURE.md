...
| Module                 | Owns                                                                                                                                                                                                                                                                    |
| ---------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `__main__.py`        | CLI surface: run,`--doctor`, `--runs`, `--show-run`, `--resume`, `--stats`, `--prune-runs`, `--list-models`, `--board`, `--serve`, `--design`, `--daemon`, `--teams`, `--deliver`, `--keep-terminals`, `--close-sessions`.                |
